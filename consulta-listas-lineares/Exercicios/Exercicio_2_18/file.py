"""
2.18 Seja um polinômio da forma P(x) = a0 xn + a1 xn - 1 + … + an; Representar P(x) através de uma lista encadeada conveniente e escrever algoritmos eficientes para efetuar as seguintes operações, onde Q(x) é um outro polinômio.  
(I) Calcular P(x0), onde x0 é um dado valor para x;
(II) P(x) + Q(x); 
(iii) P(x) • Q(x). 
